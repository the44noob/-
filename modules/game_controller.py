...
class GameController:
    ...
    def start_app(self, package_name, wait_time=5):
        ...
        try:
            ...
            # 使用ADB启动应用
            result = self.emulator.execute_command(f"shell am start -n {package_name}/com.u8.sdk.U8UnityContext")
    ...
    def find_all_images(self, template_name=None, template_path=None, threshold=0.8, region=None, max_results=10, take_new_screenshot=True):
        """
        在屏幕上查找所有匹配的图像
